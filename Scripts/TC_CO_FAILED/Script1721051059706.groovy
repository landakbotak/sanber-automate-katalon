...
WebUI.setText(findTestObject('Object Repository/Checkout Page/txt_firstname'), '')

WebUI.setText(findTestObject('Object Repository/Checkout Page/txt_lastname'), '')

WebUI.setText(findTestObject('Object Repository/Checkout Page/txt_zipcode'), '')

WebUI.click(findTestObject('Object Repository/Checkout Page/btn_continue'))

WebUI.verifyElementPresent(findTestObject('Checkout Page/txt_Error First Name is required'), 1)
